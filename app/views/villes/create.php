...
<div class="card" style="border-radius: 12px; border: 1px solid var(--border); max-width: 700px;">
    ...
    <div class="card-body" style="padding: 24px;">
        ...
        <form method="POST" action="<?php echo Flight::get('base_url'); ?>/villes/store">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                ...
                <div>
                    ...
                    <input type="text" class="form-control" id="region" name="region" 
                           value="<?php echo htmlspecialchars($data['region'] ?? ''); ?>"
            ...
            <div style="margin-bottom: 24px;">
                ...
                <textarea class="form-control" id="description" name="description" rows="4"
                          ...
                          style="padding: 12px 16px; font-size: 14px; border-radius: 8px; border: 1px solid var(--border); resize: vertical;"><?php echo htmlspecialchars($data['description'] ?? ''); ?></textarea>
            </div>
