...
<div class="section-card">
    <div class="section-body">
        ...
        <form method="POST" action="<?php echo Flight::get('base_url'); ?>/besoins/<?php echo $besoin['id']; ?>/update">
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <select class="form-select" id="ville_id" name="ville_id" required>
                        ...
                        <option value="<?php echo $ville['id']; ?>" 
                                <?php echo ($besoin['ville_id'] == $ville['id']) ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <select class="form-select" id="type_besoin" name="type_besoin" required>
                        <option value="nature" <?php echo ($besoin['type_besoin'] === 'nature') ? 'selected' : ''; ?>>Nature</option>
                        <option value="materiaux" <?php echo ($besoin['type_besoin'] === 'materiaux') ? 'selected' : ''; ?>>Matériaux</option>
                        <option value="argent" <?php echo ($besoin['type_besoin'] === 'argent') ? 'selected' : ''; ?>>Argent</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nom" name="nom" 
                       value="<?php echo htmlspecialchars($besoin['nom']); ?>" required>
            </div>

            <div class="form-group">
                <label for="description" class="form-label">Description</label>
                <textarea class="form-control" id="description" name="description" rows="3"
                          placeholder="Description détaillée du besoin"><?php echo htmlspecialchars($besoin['description'] ?? ''); ?></textarea>
            </div>
            ...
            <div class="form-grid" style="grid-template-columns: 2fr 1fr;">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="quantite_requise" name="quantite_requise" 
                           value="<?php echo htmlspecialchars($besoin['quantite_requise']); ?>" 
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="unite" name="unite" 
                           value="<?php echo htmlspecialchars($besoin['unite']); ?>" required>
                </div>
            </div>
